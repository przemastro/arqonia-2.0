...
var Galaxy = {
  ...
  'addGalaxyCenter' : function () {
    ...
    var sprite = new THREE.Sprite( ArqoniaMap.material.glow_2 );
  ...
  'showGalaxyInfos' : function() {
    ...
    if(!ArqoniaMap.showGalaxyInfos) return;

    this.infos = new THREE.Object3D();
    var obj = this;

    $.getJSON(ArqoniaMap.basePath + "data/milkyway-ed.json", function(data) {
  ...
  'infosShow' : function() {
    ...
    if(this.infos !== null)  this.infos.visible = ArqoniaMap.showGalaxyInfos;
  },
  ...
  'infosUpdateCallback' : function(scale) {
    ...
    if(!ArqoniaMap.showGalaxyInfos || this.infos == null) return;
  ...
  'add2DPlane' : function() {
    ...
    //-- Load textures
    var back2D = texloader.load(ArqoniaMap.basePath + "assets/images/milkyway.jpg");
